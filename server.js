...
"Ser\u00E1 um prazer atender sua empresa!\n" +
"Selecione abaixo o setor desejado:";

const MENSAGEM_FINAL_COMERCIAL =
"Grata pelas informa\u00E7\u00F5es!\n" +
"Logo nosso representante entrar\u00E1 em contato para lhe atender.\n" +
"Obrigada por escolher a Mercoplasa! \u{1F499}";

const SETORES = [
{ id: "comercial", numero: "1", titulo: "Comercial - Cota\u00E7\u00E3o", tipo: "comercial" },
...
return (
"Para dar continuidade ao seu atendimento, clique no link abaixo.\n" +
`Ele ir\u00E1 direcionar voc\u00EA diretamente para o "setor ${setor.titulo}", onde sua solicita\u00E7\u00E3o ser\u00E1 atendida pela equipe respons\u00E1vel.\n` +
"\u{1F447}\n" +
`\u{1F517} https://wa.me/${setor.contato}`
);
}
...
if (!setor) {
await enviarTexto(from, "N\u00E3o entendi. Pode escolher uma das op\u00E7\u00F5es da lista, ou responder com o n\u00FAmero de 1 a 5?");
return;
}
...
await enviarTexto(from, "Qual modelo de nossa linha voc\u00EA tem interesse?");
